...
#         access_token = request.httprequest.headers.get("access_token")
    ...
    # BOM Create Logic   
    @http.route('/api/bom_part_creates/', type='json', auth="public")
        ...
        if access_token in acs_token_ids:
            if kw.get("pp"):
                for i in kw.get("pp"):
                    ...
                    _logger.info("*************Product Temp Rec***********")
                    _logger.info(product_templ_rec)
                    ...
                    _logger.info("*************MRP Bom Rec***********")
                    _logger.info(mrp_bom_obj)
                    if mrp_bom_obj:
